...
<div class="container">
    <?php include "includes/nav2.php"; ?><br><br><br><br>
	<!-- navbar ends -->
	<!-- info alert -->
		...
		<table class="table table-bordered">
			<thead>
				<tr> 
		            ...
		            <th>Borrow date</th>
		            <th>Return Date</th>
		            <th style="width: fit-content;">Overdue Charges in ₱</th>
				</tr>    
			</thead>  
						...
						<td><?php echo $row['memberName']; ?></td>
		             	...
		             	<td> 
							...
							<form action="fine-student.php" method="post">
		             			<input style="margin-le: 20px;" type="hidden" name="id" value="<?php echo $row['borrowId']; ?>">
								<button style="margin-left: 50px; margin-top: -25px;" name="check" type="submit" class="btn btn-warning">CHECK</button>
							</form>
						</td>
					</tr> 
		            <?php } ?> 
