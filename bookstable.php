...
<body>
    ...
    <div class="content-wrapper">
        <div class="container">
            ...
            <div class="col-md-12">
                    <a href="addbook.php"><button class="btn btn-success col-lg-3 col-md-4 col-sm-11 col-xs-11 button" style="margin-left: -10px;margin-bottom: 0px"><span class="glyphicon glyphicon-plus-sign"></span> Add </button></a><br><br>
            </div><br><br>
            <br><br>
            <div class="row">
                <div class="col-md-12">
                                    ...
                                    <tbody>
                                        ...
                                        if($query->rowCount() > 0){
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="center">
                                                    <a href="editbook.php?bookid=<?php echo htmlentities($result->bookId);?>"><button class="btn btn-primary"><i class="fa fa-edit"></i> Edit</button></a>
                                                    <a href="bookstable.php?del=<?php echo htmlentities($result->bookId);?>" onclick="return confirm('Are you sure you want to delete?');""><button class="btn btn-danger"><i class="fa fa-pencil"></i> Delete</button></a>
                                                </td>
                                            </tr>
                                        <?php $cnt=$cnt+1;}}?>
                                    </tbody>
